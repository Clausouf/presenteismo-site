...
export default function CalendarioPage() {
  ...
  // Formata horário: "08:00:00" → "08:00" | "08:00" → "08:00" | null → null
  const formatHorario = (h: string | null | undefined): string | null => {
    if (!h) return null;
                        ...
                        <div className="px-3 py-2.5 bg-white space-y-2">
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              {horario ? (
                                <p className="text-xs font-semibold text-gray-800">{horario}</p>
                              ) : (
